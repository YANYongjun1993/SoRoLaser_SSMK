...
% 更新ref为重新采样后的数据
ref = [ref_resampled,ref_resampled];
...
new_time_db = 0.01:sampling_interval:size(ref,2)*0.01;
for i = 1:figRow
    subplot(figRow,1,i);
    plot(new_time_db,ref(i,:),'Linewidth',1)
    hold on
    plot(new_time_db,refReconst(i,:),'k:','Linewidth',2)
end
