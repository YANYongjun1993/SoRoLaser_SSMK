...
ksysid = ksysid( data4sysid, ...
        ...
        'obs_type' , { 'fourier-sparser' } ,...    % type of basis functions:poly, fourier, fourier-sparser, gaussian, hermite
...
[ yDataPredHoriz ] = valOverHorizion_plot(yDataPredHoriz, data4sysid.val{1,1});
%%
