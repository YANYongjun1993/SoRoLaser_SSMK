...
fileName = fullfile('processedData', sprintf('SSMPDecayObs_%s.mat', current_date));
...
% Create the dynamic file name with the folder path
fileName = fullfile('processedData', sprintf('figure8SSMP_%s.mat', current_date));

% Save the trajectory data
save(fileName, 'lowDimCtrl');

% Create the dynamic file name with the folder path
fileName = fullfile('processedData', sprintf('figure8SSMPObs_%s.mat', current_date));
