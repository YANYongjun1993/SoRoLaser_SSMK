...
Yu = zu; 
load SSM_model.mat
CtrlData1 = projectTrajectories(ssm_model.IMInfo, Yu); % Project down
...
CtrlData1Packed = struct('t', zu{1,1}', 'u', uCell{1,2}(:,(sizeBeforeEmbed-sizeAfterEmbed+1):end)', 'y', CtrlData1{1,2}','x',CtrlData1{1,2}');
ObsEmdbCtrl{1} = Yu{1,2}';
...
Yu = zu; 
load SSM_model.mat
CtrlData2 = projectTrajectories(ssm_model.IMInfo, Yu); % Project down
sizeAfterEmbed = size(CtrlData2{1,2},2);
sizeBeforeEmbed = size(keptIdxs,2);
% pack the trajectory and control input data at the low dimentional as struct
CtrlData2Packed = struct('t', zu{1,1}', 'u', uCell{1,2}(:,(sizeBeforeEmbed-sizeAfterEmbed+1):end)',  'y', CtrlData2{1,2}','x',CtrlData2{1,2}');
ObsEmdbCtrl{2} = Yu{1,2}';
...
sizeBeforeEmbed = size(keptIdxs,2);
% pack the trajectory and control input data at the low dimentional as struct
CtrlData3Packed = struct('t', zu{1,1}', 'u', uCell{1,2}(:,(sizeBeforeEmbed-sizeAfterEmbed+1):end)',  'y', CtrlData2{1,2}','x',CtrlData2{1,2}');
ObsEmdbCtrl{3} = Yu{1,2}';
